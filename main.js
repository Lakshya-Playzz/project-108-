...
function gotResult(error,result){
 ...
 if(soundName == "saying cat"){
     document.getElementById("image1").src = "cat.jpg"
 }
 else if(soundName == 'Saying "lion"' ){
     document.getElementById("image1").src = "lion.jpg"
 }
 else if(soundName == 'saying "cow"'){
     document.getElementById("image1").src = "cow.jpg"
 }
 else{
     document.getElementById("image1").src = "house sparrow.jpeg"
 }
